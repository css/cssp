...
"any":function(){var $elf=this,_fromIdx=this.input.idx;return this._apply("anything")},
...
"declaration":function(){var $elf=this,_fromIdx=this.input.idx,t,p,v;return (function(){t=this._apply("anything");p=this._apply("any");v=this._apply("any");return [t,p,v]}).call(this)},
...
"uri":function(){var $elf=this,_fromIdx=this.input.idx,t,x;return (function(){t=this._apply("anything");x=this._apply("any");return [t,x]}).call(this)},
...
"function":function(){var $elf=this,_fromIdx=this.input.idx,t,x,y;return (function(){t=this._apply("anything");x=this._apply("any");y=this._many((function(){return this._apply("anys")}));return [t,x].concat(y)}).call(this)}});var CSSTranslator=exports.CSSTranslator=objectThatDelegatesTo(OMeta,{
