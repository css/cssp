...
"combi_selector":function(){var $elf=this,_fromIdx=this.input.idx,s0,x,s1,y;return (function(){s0=this._many((function(){return this._apply("sc")}));x=this._apply("combinator");s1=this._many((function(){return this._apply("sc")}));y=this._apply("any");return this.concat(s0,[x],s1,[y])}).call(this)},
...
"any":function(){var $elf=this,_fromIdx=this.input.idx,x,x,y,s0,x,s1,s0,x,s1;return this._or((function(){return (function(){x=this._or((function(){return this._apply("class")}),(function(){return this._apply("STRING")}),(function(){return this._apply("PERCENTAGE")}),(function(){return this._apply("DIMENSION")}),(function(){return this._apply("HASH")}),(function(){return this._apply("NUMBER")}),(function(){return this._apply("uri")}),(function(){return this._apply("func")}),(function(){return this._apply("IDENT")}));return x}).call(this)}),(function(){return (function(){x=this._many((function(){return this._apply("unary_operator")}));y=this._or((function(){return this._apply("PERCENTAGE")}),(function(){return this._apply("DIMENSION")}),(function(){return this._apply("NUMBER")}));return x.concat(y)}).call(this)}),(function(){return (function(){switch(this._apply('anything')){case "(":return (function(){s0=this._many((function(){return this._apply("sc")}));x=this._many((function(){return this._apply("any")}));s1=this._many((function(){return this._apply("sc")}));this._applyWithArgs("exactly",")");return this.concat(["braces","(",")"],s0,x,s1)}).call(this);case "[":return (function(){s0=this._many((function(){return this._apply("sc")}));x=this._many((function(){return this._apply("any")}));s1=this._many((function(){return this._apply("sc")}));this._applyWithArgs("exactly","]");return this.concat(["braces","[","]"],s0,x,s1)}).call(this);default: throw fail}}).call(this)}))}});(CSSParser["concatContent"]=(function (x,y){y.forEach((function (e){(x=x.concat(e))}));return x}));(CSSParser["concat"]=(function (){var x = [];for(var i = undefined in arguments){(x=x.concat(arguments[i]))};undefined;return x}));var CSSTransformer=exports.CSSTransformer=objectThatDelegatesTo(OMeta,{
