...
"COMMENT":function(){var $elf=this,_fromIdx=this.input.idx,x,y;return (function(){y=(function(){x=this._many((function(){return this._apply("anything")}));return x.join("")}).call(this);this._applyWithArgs("m_comment",y);return ["comment",y]}).call(this)},
...
"stylesheet":function(){var $elf=this,_fromIdx=this.input.idx,x;return (function(){x=this._many((function(){return this._or((function(){return this._apply("CDO")}),(function(){return this._apply("CDC")}),(function(){return this._apply("S")}),(function(){return this._apply("statement")}))}));return this.concat(["stylesheet"],x)}).call(this)},
...
"atrule":function(){var $elf=this,_fromIdx=this.input.idx,ap,r,ak,ap,b,ak,ap;return this._or((function(){return (function(){switch(this._apply('anything')){case "@":return (function(){this._applyWithArgs("exactly","m");this._applyWithArgs("exactly","e");this._applyWithArgs("exactly","d");this._applyWithArgs("exactly","i");this._applyWithArgs("exactly","a");"@media";ap=this._many((function(){return this._apply("atrule_part")}));this._applyWithArgs("exactly","{");this._many((function(){return this._apply("S")}));r=this._many((function(){return this._apply("ruleset")}));this._many((function(){return this._apply("S")}));this._applyWithArgs("exactly","}");return this.concat(["atrulem"],ap,r)}).call(this);default: throw fail}}).call(this)}),(function(){return (function(){ak=this._apply("ATKEYWORD");ap=this._many((function(){return this._apply("atrule_part")}));b=this._apply("block");return this.concat(["atruleb",ak],ap,[b])}).call(this)}),(function(){return (function(){ak=this._apply("ATKEYWORD");ap=this._many((function(){return this._apply("atrule_part")}));this._applyWithArgs("exactly",";");this._many((function(){return this._apply("S")}));return this.concat(["atrules",ak],ap)}).call(this)}))},
"block":function(){var $elf=this,_fromIdx=this.input.idx,x;return (function(){this._applyWithArgs("exactly","{");this._many((function(){return this._apply("S")}));x=this._many((function(){return this._apply("declaration")}));this._applyWithArgs("exactly","}");return this.concat(["block"],x)}).call(this)},
"ruleset":function(){var $elf=this,_fromIdx=this.input.idx,x,y;return (function(){x=this._many((function(){return this._apply("selector")}));y=this._apply("block");this._many((function(){return this._apply("S")}));return this.concat(["ruleset"],x,[y])}).call(this)},
...
"simple_selector":function(){var $elf=this,_fromIdx=this.input.idx,x,y;return (function(){x=this._apply("any");y=this._many((function(){return this._or((function(){return this._apply("combi_selector")}),(function(){return this._apply("space_selector")}),(function(){return this._apply("attrib")}))}));this._many((function(){return this._apply("S")}));return this.concatContent(["simpleselector",x],y)}).call(this)},
...
"value":function(){var $elf=this,_fromIdx=this.input.idx,x;return (function(){x=this._many1((function(){return this._or((function(){return this._apply("any")}),(function(){return this._apply("block")}),(function(){return this._apply("ATKEYWORD")}),(function(){return this._apply("operator")}),(function(){return this._apply("S")}))}));return this.concat(["value"],x)}).call(this)},
...
"declaration":function(){var $elf=this,_fromIdx=this.input.idx,p,v;return (function(){p=this._apply("trans");v=this._many((function(){return this._apply("trans")}));return ["declaration",p].concat(v)}).call(this)},
"property":function(){var $elf=this,_fromIdx=this.input.idx,x;return (function(){x=this._apply("trans");return ["property",x]}).call(this)},
