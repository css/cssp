...
"number":function(){var $elf=this,_fromIdx=this.input.idx,x;return (function(){x=this._apply("m_num");return ["number",x]}).call(this)},
...
"any":function(){var $elf=this,_fromIdx=this.input.idx,x,x,y,s0,x,s1,s0,x,s1;return this._or((function(){return (function(){x=this._or((function(){return this._apply("class")}),(function(){return this._apply("string")}),(function(){return this._apply("percentage")}),(function(){return this._apply("dimension")}),(function(){return this._apply("hash")}),(function(){return this._apply("number")}),(function(){return this._apply("uri")}),(function(){return this._apply("func")}),(function(){return this._apply("ident")}));return x}).call(this)}),(function(){return (function(){x=this._many((function(){return this._apply("unaryoperator")}));y=this._or((function(){return this._apply("percentage")}),(function(){return this._apply("dimension")}),(function(){return this._apply("number")}));return x.concat(y)}).call(this)}),(function(){return (function(){switch(this._apply('anything')){case "(":return (function(){s0=this._many((function(){return this._apply("sc")}));x=this._many((function(){return this._apply("any")}));s1=this._many((function(){return this._apply("sc")}));this._applyWithArgs("exactly",")");return this.concat(["braces","(",")"],s0,x,s1)}).call(this);case "[":return (function(){s0=this._many((function(){return this._apply("sc")}));x=this._many((function(){return this._apply("any")}));s1=this._many((function(){return this._apply("sc")}));this._applyWithArgs("exactly","]");return this.concat(["braces","[","]"],s0,x,s1)}).call(this);default: throw fail}}).call(this)}))}});(CSSParser["concatContent"]=(function (x,y){y.forEach((function (e){(x=x.concat(e))}));return x}));(CSSParser["concat"]=(function (){var x = [];for(var i = undefined in arguments){(x=x.concat(arguments[i]))};undefined;return x}));var CSSTransformer=exports.CSSTransformer=objectThatDelegatesTo(OMeta,{
...
"number":function(){var $elf=this,_fromIdx=this.input.idx,x;return (function(){x=this._apply("anything");return ["number",x]}).call(this)},
...
"s":function(){var $elf=this,_fromIdx=this.input.idx,x;return (function(){x=this._apply("anything");return ["s",x]}).call(this)},
